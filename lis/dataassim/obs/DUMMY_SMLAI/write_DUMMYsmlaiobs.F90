...
!BOP
! 
! !ROUTINE: write_DUMMYsmlaiobs
! \label{write_DUMMYsmlaiobs}
! 
! !REVISION HISTORY: 
! 25Jan2008: Sujay Kumar; Initial Specification
! 
! !INTERFACE: 
subroutine write_DUMMYsmlaiobs(n, k, OBS_State)
    ! !USES: 
      use ESMF
      use LIS_coreMod
      use LIS_logMod
    ...
    !EOP
      ...
      if(data_update) then 
         ...
         if(LIS_masterproc) then 
            ...
            call DUMMY_smlaiobsname(n,k,obsname)        
    ...
    end subroutine write_DUMMYsmlaiobs
    
    !BOP
    ! !ROUTINE: DUMMY_smlaiobsname
    ! \label{DUMMY_smlaiobsname}
    ! 
    ! !INTERFACE: 
    subroutine DUMMY_smlaiobsname(n,k,obsname)
    ! !USES: 
    ...
    end subroutine DUMMY_smlaiobsname
