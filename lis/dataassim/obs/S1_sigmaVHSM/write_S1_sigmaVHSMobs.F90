...
!BOP
! 
! !ROUTINE: write_S1_sigmaVHSMobs
! \label{write_S1_sigmaVHSMobs}
! 
! !REVISION HISTORY: 
! 30 Aug 2019: Hans Lievens; Initial Specification
! 
! !INTERFACE: 
subroutine write_S1_sigmaVHSMobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call S1_sigmaVHSM_obsname(n,k,obsname)        
...
end subroutine write_S1_sigmaVHSMobs

!BOP
! !ROUTINE: S1_sigmaVHSM_obsname
! \label{S1_sigmaVHSM_obsname}
! 
! !INTERFACE: 
subroutine S1_sigmaVHSM_obsname(n,k,obsname)
! !USES: 
...
end subroutine S1_sigmaVHSM_obsname
