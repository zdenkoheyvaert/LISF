...
!BOP
! 
! !ROUTINE: S1_sigmaVHSM_setup
! \label{S1_sigmaVHSM_setup}
! 
! !INTERFACE: 
  subroutine S1_sigmaVHSM_setup(k, OBS_State, OBS_Pert_State)
! !USES: 
...
!-------------------------------------------------------------
  ...
  end subroutine S1_sigmaVHSM_setup
  
end module S1_sigmaVHSM_Mod
