...
!-----------------------------------------------------------------------------
  public :: S1_sigmaVVVHSMLAI_setup
!-----------------------------------------------------------------------------
! !PUBLIC TYPES:
!-----------------------------------------------------------------------------
...
!BOP
! 
! !ROUTINE: S1_sigmaVVVHSMLAI_setup
! \label{S1_sigmaVVVHSMLAI_setup}
! 
! !INTERFACE: 
  subroutine S1_sigmaVVVHSMLAI_setup(k, OBS_State, OBS_Pert_State)
! !USES: 
    use ESMF
    use LIS_coreMod
    use LIS_timeMgrMod
...
!-------------------------------------------------------------
    ...
    call S1_sigmaVVVHSMLAI_filename(S1_filename,S1sigmaobsdir,&
                     2015,1,1)
  ...
  end subroutine S1_sigmaVVVHSMLAI_setup
  
end module S1_sigmaVVVHSMLAI_Mod
