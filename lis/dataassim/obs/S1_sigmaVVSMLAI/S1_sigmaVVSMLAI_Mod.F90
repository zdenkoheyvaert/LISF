...
!BOP
! 
! !ROUTINE: S1_sigmaVVSMLAI_setup
! \label{S1_sigmaVVSMLAI_setup}
! 
! !INTERFACE: 
  subroutine S1_sigmaVVSMLAI_setup(k, OBS_State, OBS_Pert_State)
! !USES: 
...
!-------------------------------------------------------------
  ...
  end subroutine S1_sigmaVVSMLAI_setup
  
end module S1_sigmaVVSMLAI_Mod
