...
!BOP
! 
! !ROUTINE: write_VODCAlai
! \label{write_VODCAlai}
! 
! !REVISION HISTORY: 
!  18 Nov 2021    Samuel Scherrer; initial reader based on CGLS LAI reader
! 
! !INTERFACE: 
subroutine write_VODCAlai(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
! VODCA LAI observations to a file
! 
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call VODCA_laiobsname(n,k,obsname)        
...
end subroutine write_VODCAlai

!BOP
! !ROUTINE: VODCA_laiobsname
! \label{VODCA_laiobsname}
! 
! !INTERFACE: 
subroutine VODCA_laiobsname(n,k,obsname)
! !USES: 
...
end subroutine VODCA_laiobsname
