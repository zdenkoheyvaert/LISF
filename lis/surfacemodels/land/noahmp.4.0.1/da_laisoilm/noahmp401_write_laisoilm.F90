...
!BOP
! !ROUTINE: NoahMP401_write_laisoilm
! \label{NoahMP401_write_laisoilm}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine NoahMP401_write_laisoilm(ftn,n, LSM_State)
...
end subroutine NoahMP401_write_laisoilm
