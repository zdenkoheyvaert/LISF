...
!BOP
! !ROUTINE: noahmp401_qc_laiobs_laism
! \label{noahmp401_qc_laiobs_laism}
!
! !REVISION HISTORY:
! 25Feb2008: Sujay Kumar: Initial Specification
! 1 Aug 2016: Mahdi Navari; Modified for Noahmp401 
! 19 Jan 2022: Samuel Scherrer: Copied from da_LAI
!
! !INTERFACE:
subroutine noahmp401_qc_laiobs_laism(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
end subroutine noahmp401_qc_laiobs_laism
