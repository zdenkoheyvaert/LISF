...
!BOP
! !ROUTINE: noahmp401_descale_soilmLAI
! \label{noahmp401_descale_soilmLAI}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_descale_soilmLAI(n, LSM_State, LSM_Incr_State)
...
end subroutine noahmp401_descale_soilmLAI
