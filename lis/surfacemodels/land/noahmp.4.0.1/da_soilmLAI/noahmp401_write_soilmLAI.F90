...
!BOP
! !ROUTINE: noahmp401_write_soilmLAI
! \label{noahmp401_write_soilmLAI}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_write_soilmLAI(ftn,n, LSM_State)
...
end subroutine noahmp401_write_soilmLAI
