...
!BOP
! !ROUTINE: noahmp401_qc_Sig0VHobs
! \label{noahmp401_qc_Sig0VHobs}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine noahmp401_qc_Sig0VHobs(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
!-----this part is derived from ./lis/dataassim/obs/s1_sigma/read_S1_sigma.F90
  ...
  call LIS_verify(status,&
       "ESMF_StateGet failed in noahmp401_qc_Sig0VHobs sigmaField")
...
end subroutine noahmp401_qc_Sig0VHobs
