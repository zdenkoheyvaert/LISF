...
#include "LIS_misc.h"
!BOP
! !ROUTINE: Noahmp401_sfc2wcm
!  \label{Noahmp401_sfc2wcm}
!
! !REVISION HISTORY:
!  4 Sep 2020: Sara Modanesi; Initial Specification
! !INTERFACE:
subroutine noahmp401_sfc2wcm(n, sfcState)
! !USES:      
  use ESMF
  use LIS_coreMod
...
!EOP
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     soil_moisture_content(t) = NOAHMP401_struc(n)%noahmp401(t)%smc(1)
     Leaf_Area_Index(t) = NOAHMP401_struc(n)%noahmp401(t)%lai
  enddo

end subroutine noahmp401_sfc2wcm
