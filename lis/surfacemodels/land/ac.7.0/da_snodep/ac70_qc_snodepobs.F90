...
!BOP
! !ROUTINE: ac70_qc_snodepobs
! \label{ac70_qc_snodepobs}
!
! !REVISION HISTORY:
...
!  03 Oct 2018: Yeosang Yoon; Modified for Ac70
!
! !INTERFACE:
subroutine ac70_qc_snodepobs(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
end subroutine ac70_qc_snodepobs
