...
!BOP
! !ROUTINE: ac70_updatesnodepvars
! \label{ac70_updatesnodepvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine ac70_updatesnodepvars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
end subroutine ac70_updatesnodepvars
