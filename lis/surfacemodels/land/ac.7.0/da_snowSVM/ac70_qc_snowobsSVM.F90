...
!BOP
! !ROUTINE: ac70_qc_snowobsSVM
! \label{ac70_qc_snowobsSVM}
!
! !REVISION HISTORY:
! 25Feb2008: Sujay Kumar: Initial Specification
!
! !INTERFACE:
subroutine ac70_qc_snowobsSVM(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)
     ...
     stc1(t) = ac70_struc(n)%ac70(t)%sstc(1)
...
end subroutine ac70_qc_snowobsSVM
