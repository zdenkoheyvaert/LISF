...
!BOP
! !ROUTINE: ac70_updatesnowvarsSVM
! \label{ac70_updatesnowvarsSVM}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine ac70_updatesnowvarsSVM(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
...
!EOP
  ...
  enddo
end subroutine ac70_updatesnowvarsSVM
