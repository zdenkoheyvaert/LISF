...
! This subroutine is called by subroutine ac70_getsnwdpred
!
! Written by Yonghwan Kwon (01 Aug. 2017)
!-----------------------------------------------------------------

subroutine ac70_LIS_SVM(n, k, swe_obsgrid, slwc_obsgrid, tp1_obsgrid, &
...
!EOP
  ...
  !case_directory = '/discover/nobackup/projects/hma/users/ykwon/LIS/kyh_case/ac70_SynDA_kyh_02/'
  case_directory = '/discover/nobackup/projects/hma/users/ykwon/LIS/kyh_case/ac70_HMA/'
