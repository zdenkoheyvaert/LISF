...
!BOP
! !ROUTINE: ac70_descale_soilmLAI
! \label{ac70_descale_soilmLAI}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine ac70_descale_soilmLAI(n, LSM_State, LSM_Incr_State)
...
end subroutine ac70_descale_soilmLAI
