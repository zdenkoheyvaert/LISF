...
! 28 Jun 2018; Chandana Gangodagamage Modified for the Ac70
! 19 Jan 2021; Dan Rosen, Remove commented code blocks
! 
! !INTERFACE:
subroutine ac70_setwrfexport(n)
! !USES:
  use ESMF
  use LIS_coreMod
...
!EOP
  ...
  call LIS_patch2tile(n,LIS_rc%lsm_index,LISWRF_export(n)%snow_t,&
       AC70_struc(n)%ac70%sneqv*1000.0)
