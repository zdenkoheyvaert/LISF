...
!BOP
! !ROUTINE: Ac70_getpeobspred_ISMNsmobs
!  \label{Ac70_getpeobspred_ISMNsmobs}
!
! !REVISION HISTORY:
! 02 Feb 2018: Soni Yatheendradas; Initial Specification
!
! !INTERFACE:
subroutine Ac70_getpeobspred_ISMNsmobs(Obj_Func)
! !USES:
  use ESMF
...
!  write(LIS_logunit,*) '[INFO] Here 1 in Ac70_getpeobspred_ISMNsmobs '
...
!  write(LIS_logunit,*) '[INFO] Here 2 in Ac70_getpeobspred_ISMNsmobs '
...
!  write(LIS_logunit,*) '[INFO] Finished Ac70_getpeobspred_ISMNsmobs, smc = ', smc

end subroutine Ac70_getpeobspred_ISMNsmobs
