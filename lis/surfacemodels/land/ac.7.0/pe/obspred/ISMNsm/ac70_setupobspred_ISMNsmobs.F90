...
!BOP
! !ROUTINE: Ac70_setupobspred_ISMNsmobs
!  \label{Ac70_setupobspred_ISMNsmobs}
!
! !REVISION HISTORY:
! 2 Feb 2018: Soni Yatheendradas; Initial Specification
!
! !INTERFACE:
subroutine Ac70_setupobspred_ISMNsmobs(OBSPred)
! !USES:
  use ESMF
...
!       name="ISMNsm standard deviation of soil moisture", rc=status)
!  call LIS_verify(status)
!  
!  call ESMF_StateAdd(OBSPred,(/smstdField/),rc=status)
!  call LIS_verify(status)
end subroutine Ac70_setupobspred_ISMNsmobs
