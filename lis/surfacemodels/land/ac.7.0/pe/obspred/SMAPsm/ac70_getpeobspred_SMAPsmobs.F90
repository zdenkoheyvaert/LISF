...
!BOP
! !ROUTINE: Ac70_getpeobspred_SMAPsmobs
!  \label{Ac70_getpeobspred_SMAPsmobs}
!
! !REVISION HISTORY:
! 02 Feb 2018: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine Ac70_getpeobspred_SMAPsmobs(Obj_Func)
! !USES:
  use ESMF
...
!  write(LIS_logunit,*) '[INFO] Here 1 in Ac70_getpeobspred_SMAPsmobs '
...
!  write(LIS_logunit,*) '[INFO] Here 2 in Ac70_getpeobspred_SMAPsmobs '
...
!  write(LIS_logunit,*) '[INFO] Finished Ac70_getpeobspred_SMAPsmobs, smc = ', smc

end subroutine Ac70_getpeobspred_SMAPsmobs
