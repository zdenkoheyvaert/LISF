...
!BOP
! !ROUTINE: Ac70_setupobspred_SMAPsmobs
!  \label{Ac70_setupobspred_SMAPsmobs}
!
! !REVISION HISTORY:
! 2 Feb 2019: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine Ac70_setupobspred_SMAPsmobs(OBSPred)
! !USES:
  use ESMF
...
!  call LIS_verify(status)
end subroutine Ac70_setupobspred_SMAPsmobs
