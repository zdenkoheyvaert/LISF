...
!BOP
! !ROUTINE: Ac70_setupobspred_ARSsmobs
!  \label{Ac70_setupobspred_ARSsmobs}
!
! !REVISION HISTORY:
! 2 Feb 2018: Soni Yatheendradas; Initial Specification
!
! !INTERFACE:
subroutine Ac70_setupobspred_ARSsmobs(OBSPred)
! !USES:
  use ESMF
...
!  call LIS_verify(status)
end subroutine Ac70_setupobspred_ARSsmobs
