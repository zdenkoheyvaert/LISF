...
!---------------------------------------------------------------------------  
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)
     ...
     smc3(t) = ac70_struc(n)%ac70(t)%smc(3)
     smc4(t) = ac70_struc(n)%ac70(t)%smc(4)

     sh2o1(t) = ac70_struc(n)%ac70(t)%sh2o(1)
     sh2o2(t) = ac70_struc(n)%ac70(t)%sh2o(2)
     sh2o3(t) = ac70_struc(n)%ac70(t)%sh2o(3)
     sh2o4(t) = ac70_struc(n)%ac70(t)%sh2o(4)
!--------------------------------------------------------------------------------------------------------- 
