...
!BOP
! 
! !ROUTINE: ac70_datws_init
! \label{ac70_datws_init}
! 
! !INTERFACE:
  subroutine ac70_datws_init(k)
! !USES:
! !DESCRIPTION:        
!
!EOP
...
!Hardcoded for now.
  ...
  end subroutine ac70_datws_init
end module ac70_datws_Mod
