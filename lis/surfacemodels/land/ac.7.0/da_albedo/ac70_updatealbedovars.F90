...
!BOP
! !ROUTINE: ac70_updatealbedovars
! \label{ac70_updatealbedovars}
!
! !REVISION HISTORY:
! 22 Dec 2017: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine ac70_updatealbedovars(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use ac70_lsmMod
...
end subroutine ac70_updatealbedovars
