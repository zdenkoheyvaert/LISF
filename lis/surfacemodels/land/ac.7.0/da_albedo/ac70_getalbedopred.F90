...
!BOP
! !ROUTINE: ac70_getALBEDOpred
! \label{ac70_getALBEDOpred}
!
! !REVISION HISTORY:
! 22 Dec 2017: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine ac70_getALBEDOpred(n, k,obs_pred)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1, LIS_rc%npatch(n,LIS_rc%lsm_index)
     albedo(t) = AC70_struc(n)%ac70(t)%albd(1)
  enddo
...
end subroutine ac70_getALBEDOpred
