...
!BOP
! !ROUTINE: ac70_getSig0VVVHpred
! \label{ac70_getSig0VVVHpred}
!
! !REVISION HISTORY:
...
subroutine ac70_getSig0VVVHpred(n,k,obs_pred)
...
end subroutine ac70_getSig0VVVHpred
